...
- [ ] enums | oracle/pending/enums.zig | self-discovered atomic gap (real zig=55)
...
- [ ] structmethod_s2 | oracle/pending/structmethod_s2.zig | ladder step for 'structmethod' (real zig=42)
...
- [ ] switchrange_s1 | oracle/pending/switchrange_s1.zig | ladder step for 'switchrange' (real zig=42)
...
- [ ] errorunion_s5 | oracle/pending/errorunion_s5.zig | ladder step for 'errorunion' (real zig=120)
...
- [ ] errorset_s2 | oracle/pending/errorset_s2.zig | ladder step for 'errorset' (real zig=60)
